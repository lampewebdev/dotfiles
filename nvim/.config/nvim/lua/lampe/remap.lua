...
vim.keymap.set("n", "<leader>e", ":NeoTreeFocusToggle<cr>", { desc = "Toggle Nvim Tree" })
vim.keymap.set("n", "<leader>s", ":NeoTreeReveal<cr>:NeoTreeFocus<cr>", { desc = "Show file in Nvim Tree" })
